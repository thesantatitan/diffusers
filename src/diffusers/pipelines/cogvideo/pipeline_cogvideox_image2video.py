...
class CogVideoXImageToVideoPipeline(DiffusionPipeline):
    ...
    def prepare_latents(
        ...
        import sys
        print(f'HEYO : {image_latents.shape} : {latent_padding.shape}', file=sys.stderr)
        print(f'HEYO : {image_latents.shape} : {latent_padding.shape}', file=sys.stdout)
    ...
    def __call__(
        ...
        import sys
        print(f'LOLOL : {image.shape}', file=sys.stderr)
